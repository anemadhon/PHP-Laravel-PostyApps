    ...
    <div class="flex justify-center">
        <div class="w-4/12 bg-white p-6 rounded-lg">
            <form action="{{route('register')}}" method="POST">
                ...
                <div class="mb-4">
                    <label for="password_confirmation" class="sr-only">Re-Type Your Password</label>
                    <input type="password" name="password_confirmation" id="password_confirmation" placeholder="Your Password Again" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('password') border-red-500 @enderror">
                    @error('password')
                    <div class="text-red-500 mt-2 text-sm">
                        {{$message}}
                    </div>
